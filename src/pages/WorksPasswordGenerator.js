                        ...
                        <div id="single">
                            <div className="row gutter-width-lg single-content">
                                ...
                                <div className="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                                    ...
                                    <h1 className="small">Password Generator</h1>

                                    <div className="description">

                                        <p>This project is a password generator allowing user to <strong>create a strong password</strong> that provides greater security.</p>
                                        ...
                                        {/* <div>Icons made by <a href="https://www.flaticon.com/authors/fauzidea" title="FauzIDEA">FauzIDEA</a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a></div> */}
                                            <h4>  <img src="assets/img/placeholder/atom.png" alt="" height="28" width="28" /> <a href="https://noemiegrau.github.io/password-generator/" target="_blank" rel="noopener noreferrer" >See Deployed App</a></h4>
                                        </div> <br />
...
export default WorksPasswordGenerator;
