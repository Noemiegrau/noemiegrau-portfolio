                        ...
                        <div id="single">
                            <div className="row gutter-width-lg single-content">
                                ...
                                <div className="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                                    ...
                                    <h1 className="small">Shop Shop</h1>

                                    <div className="description">

                                        <p>This single page <strong>MERN app is an e-commerce websites</strong> where users can create an account, filter products through categories, <strong>place products in their cart and buy them</strong>. This application also uses front-end routing, api requests (queries and mutations), <strong>user authentication and Global State</strong>.
</p>
                                        ...
                                        {/* <div>Icons made by <a href="https://www.flaticon.com/authors/fauzidea" title="FauzIDEA">FauzIDEA</a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a></div> */}
                                            <h4>  <img src="assets/img/placeholder/atom.png" alt="" height="28" width="28" /> <a href="https://nameless-mountain-67989.herokuapp.com/" target="_blank" rel="noopener noreferrer" >See Deployed App</a></h4>
                                        </div> <br />
                                        ...
                                        <div className="transform-scale-h">
                                            ...
                                            </svg>  <a href="https://github.com/Noemiegrau/shop-shop" target="_blank" rel="noopener noreferrer" >See GitHub</a></h4>
                                        </div>
