                        ...
                        <div id="single">
                            <div className="row gutter-width-lg single-content">
                                ...
                                <div className="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                                    ...
                                    <h1 className="small">Weather Dashboard</h1>

                                    <div className="description">

                                        <p>This project is a <strong>weather dashboard</strong> application. The user can look for <strong>different cities</strong> and their corresponding <strong>5-day forecast weather</strong>.</p>
                                        ...
                                        {/* <div>Icons made by <a href="https://www.flaticon.com/authors/fauzidea" title="FauzIDEA">FauzIDEA</a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a></div> */}
                                            <h4>  <img src="assets/img/placeholder/atom.png" alt="" height="28" width="28" /> <a href="https://noemiegrau.github.io/weather-dashboard/" target="_blank" rel="noopener noreferrer" >See Deployed App</a></h4>
                                        </div> <br />
                                        ...
                                        <div className="transform-scale-h">
                                            ...
                                            </svg>  <a href="https://github.com/Noemiegrau/weather-dashboard" target="_blank" rel="noopener noreferrer" >See GitHub</a></h4>
                                        </div>
...
export default WorksWeatherDashboard;
