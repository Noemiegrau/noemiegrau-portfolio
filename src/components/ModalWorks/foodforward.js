                        ...
                        <div id="single">
                            <div className="row gutter-width-lg single-content">
                                ...
                                <div className="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                                    ...
                                    <h1 className="small">Food Forward</h1>

                                    <div className="description">

                                        <p>This project is a <strong>full-stack</strong> website application using <strong>Model-View-Controller (MVC) paradigm</strong>. It is a food bank website directed towards its employees where they will be able to <strong>log in safely</strong> into their account via <strong>email and protected password</strong>, have access to the food bank customer's personal information, <strong>modify, and delete these database information</strong>. The employees also have access to a <strong>social media</strong> like platform where they can post information concerning their work at the food bank, comment on these posts, and like.</p>
                                        ...
                                        {/* <div>Icons made by <a href="https://www.flaticon.com/authors/fauzidea" title="FauzIDEA">FauzIDEA</a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a></div> */}
                                            <h4>  <img src="assets/img/placeholder/atom.png" alt="" height="28" width="28" /> <a href="https://stark-reaches-12893.herokuapp.com/" target="_blank" rel="noopener noreferrer" >See Deployed App</a></h4>
                                        </div> <br />
                                        ...
                                        <div className="transform-scale-h">
                                            ...
                                            </svg>  <a href="https://github.com/Noemiegrau/food-forward" target="_blank" rel="noopener noreferrer" >See GitHub</a></h4>
                                        </div>
...
export default WorksFoodForward;
